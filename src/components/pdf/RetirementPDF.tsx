...
const styles = StyleSheet.create({
  page: { padding: 40, paddingBottom: 70, fontSize: 12 },
  ...
  disclaimer: { fontSize: 9, color: '#9ca3af', marginTop: 16, lineHeight: 1.5 },
  footer: { position: 'absolute', bottom: 24, left: 40, right: 40, borderTopWidth: 1, borderTopColor: '#e5e7eb', paddingTop: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  footerText: { fontSize: 9, color: '#9ca3af' },
  footerLink: { fontSize: 9, color: '#059669' },
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {/* Footer with 卡片表哥 branding */}
        <View style={styles.footer} fixed>
          <BT style={styles.footerText}>
            {isZh ? '由 RetireKO 產生 · 一拳擊倒你的退休焦慮' : 'Generated by RetireKO · Knock Out Your Retirement Anxiety'}
          </BT>
          <Link src="https://zettelcousin.tw/retireko-retirement-planning-tool/" style={styles.footerLink}>
            <Text style={{ fontFamily: 'NotoSansLatin', fontSize: 9, color: '#059669' }}>zettelcousin.tw</Text>
          </Link>
        </View>
      </Page>
